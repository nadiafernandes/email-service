...
exports.start = function(db){
    //to fix a heroku problem do not allow me to do 2 mongo connections with the free module
    if(db){
        mongodb = db;
        emailQueueCollection = mongodb.collection(config.mongodb.emailCollection);
    }
